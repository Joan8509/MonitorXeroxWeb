  ...
  <main class="login-shell" aria-labelledby="login-title">
    <section class="login-hero" aria-label="{htmlmod.escape(overview)}">
      <div class="login-hero-card">
        ...
        <div class="login-stats" aria-hidden="true"><span><strong>B7135</strong> {htmlmod.escape(ready)}</span><span><strong>B415</strong> Online</span><span><strong>B8155</strong> Online</span></div>
      </div>
    </section>
